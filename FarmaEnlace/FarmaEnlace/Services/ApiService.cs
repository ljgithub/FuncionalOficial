...
namespace FarmaEnlace.Services
{
    public class ApiService
    {
            ...
            string email)
        {
            try
            {
                var userRequest = new UserRequest { Identification = identification, Email = email};
        ...
        public async Task<Response> ChangeUser(
            string urlBase,
            string servicePrefix,
            string controller,
            string tokenType,
            ...
            string password)
        {
            try
            {
                var client = new HttpClient();
                client.BaseAddress = new Uri(urlBase);
                var response = await client.PostAsync(Application.Current.Resources["PrefixAPIToken"].ToString(),
            ...
            string controller)
        {
            try
            {
                ...
                if (!response.IsSuccessStatusCode)
                {
                    ...
                    var error = JsonConvert.DeserializeObject<Response>(errorMessage);
                    return new Response
                    {
                        IsSuccess = false,
            ...
            string controller)
        {
            try
            {
                ...
                if (!response.IsSuccessStatusCode)
                {
                    ...
                    {
                        IsSuccess = false,
                        Message = Resources.Resource.TryAgain,
                    };
                }
        ...
        public async Task<Response> SaveStaticts<T>(
            string urlBase,
            string servicePrefix,
            string controller,
            List<T> model) 
