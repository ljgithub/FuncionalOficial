...
{
    public partial class CommerceMapView : ContentPage
    {
        ...
        public CommerceMapView()
        {
            ...
            MyMapCommerce.MoveToRegion(MapSpan.FromCenterAndRadius(posicionEcuador, Distance.FromKilometers(250)));
        ...
        async Task<bool> LoadPins()
        {
            ...
            var commerceMapViewModel = CommerceMapViewModel.GetInstance();
            var Pins = commerceMapViewModel.Pins;
            List<Position> position = new List<Position>();
            MyMapCommerce.CustomPins = new List<CustomPin>();
            foreach (var pin in Pins)
            {
                ...
                MyMapCommerce.CustomPins.Add(customPin);
                MyMapCommerce.Pins.Add(customPin);
                position.Add(pin.Position);
            }
            MyMapCommerce.MoveToRegion(FromPositions(position));
            return true;
        }
